          ...
          {channel && (
            <>
              <button
                ...
                onClick={() => useChatStore.getState().setActiveChannel('')}
                title="Return to Workspace Overview / Welcome Dashboard"
              ...
              {isAIChat && (
                ...
                >
                  ...
                  <span className="chat-header__btn-text">Clear Chat</span>
                </button>
              )}
